...
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(1, 'Search Form Area', 'getSearchForm', NULL, 'home.inc.search', 0, 0, 0, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(2, 'Sponsored Ads', 'getSponsoredPosts', NULL, 'home.inc.featured', 0, 2, 3, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(3, 'Latest Ads', 'getLatestPosts', NULL, 'home.inc.latest', 0, 4, 5, 1, 1);
...
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(5, 'Locations & Country Map', 'getLocations', NULL, 'home.inc.locations', 0, 8, 9, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(6, 'Companies', 'getFeaturedPostsCompanies', NULL, 'home.inc.companies', 0, 10, 11, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(7, 'Mini Stats', 'getStats', NULL, 'home.inc.stats', 0, 12, 13, 1, 1);
...
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(9, 'Advertising #2', 'getBottomAdvertising', NULL, 'layouts.inc.advertising.bottom', 0, 16, 17, 1, 0);
